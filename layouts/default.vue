      ...
      >
        <div>
          <nuxt-link v-if="theme === 'theme-light'" to="/"
            ><img src="~/assets/img/rf.png" alt="logo" class="w-32"
          /></nuxt-link>
          <nuxt-link v-else to="/"
            ><img src="~/assets/img/rf-white.png" alt="logo" class="w-32"
          /></nuxt-link>
        </div>
        ...
        >
          ...
          <li>
            <a
              href="https://github.com/rizkyfirman15/"
              class="text-copy-primary hover:text-gray-600"
            >
              Github
            </a>
          ...
          <li>
            <a
              href="https://rizkyfirman.medium.com/"
              class="text-copy-primary hover:text-gray-600"
            >
              Blog
            </a>
    ...
    <footer class="bg-green-700 text-white">
      ...
      >
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a
              href="mailto:rizkyfirmansyah3344@gmail.com"
          ...
          <li>
            <a
              href="https://www.youtube.com/channel/UCJ0OT7tKk5IOR-Ohxl34S4w"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
              <svg
          ...
          <li>
            <a
              href="https://instagram.com/rizkyfirman_15/"
              target="_blank"
              class="text-white hover:text-gray-400"
            >
              <svg
